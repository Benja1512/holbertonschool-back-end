...
def get_employee_todo_progress(employee_id):
    ...
    try:
        ...
        # Llamar a la función para exportar a JSON
...
def export_to_json(employee_id, employee_name, completed_tasks):
    # Crear datos JSON
    json_data = {str(employee_id): [{"task": task["title"], "completed": task["completed"], "username": employee_name} for task in completed_tasks]}
    ...
    print(f"JSON file '{json_filename}' creado exitosamente con las tareas completadas para el empleado {employee_name}.")
